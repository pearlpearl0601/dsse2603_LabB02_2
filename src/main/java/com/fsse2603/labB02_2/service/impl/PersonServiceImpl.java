...
import com.fsse2603.labB02_2.exception.person.PersonNotFoundException;
...
//    }
    ...
    @Override
    public PersonResponseData updatePerson(UpdatePersonRequestData requestData) {
        try {
//            for (PersonEntity personEntity : personEntityList) {
//                if (personEntity.getHkid().equals(requestData.getHkid())) {
//                    personEntity.setFirstName(requestData.getFirstName());
//                    personEntity.setLastName(requestData.getLastName());
//
...
//            }
//
//            throw new PersonNotFoundException(requestData.getHkid());

            PersonEntity personEntity = getEntityByHkid(requestData.getHkid());
            personEntity.setFirstName(requestData.getFirstName());
            personEntity.setLastName(requestData.getLastName());
            PersonResponseData responseData = personDataMapper.toPersonResponseData(personEntity);
            return responseData;
